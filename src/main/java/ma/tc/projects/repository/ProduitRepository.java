...
public interface ProduitRepository extends JpaRepository<Produit, Long> {
	...
	@Query(value = "SELECT P.id_produit, p.code_produit, p.date_exp, p.date_pro, p.description, p.image, p.libelle, p.id_categorie FROM produits p ORDER BY p.id_produit", nativeQuery = true)
